###############################################################################
# Messaging API for Java (JCSMP)
#                      
# Copyright 2005-2025 Solace Corporation. All rights reserved.
###############################################################################

See the docs directory for more information.
See the lib/dependencies.txt for all libraries needed to build/run applications.

Note that the sol-jcsmp jar includes metadata conforming to the OSGi standards and can be deployed as an OSGi bundle.
