...
import com.solacesystems.jcsmp.samples.introsamples.common.SampleUtils.UserVpn;
...
public class ArgParser {
    ...
    public static String getSecureArgUsage() {
        ...
        buf.append("\t[-exclprot PROTOCOL]  A comma separated list of encryption protocol(s) to exclude - values [tlsv1.1, tlsv1.2, tlsv1.3] (default: none)\n");
