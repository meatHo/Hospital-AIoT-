 ...
 * any application.
 * 
 * Copyright 2006-2025 Solace Corporation. All rights reserved.
 */
...
//			System.out.print(msg.dump());
	...
	void run(String[] args) {
		...
		try {
			...
			Topic topic = JCSMPFactory.onlyInstance().createTopic("t/1");
...
//				} else {
//					msg.writeAttachment((SampleUtils.attachmentText + "this is an odd number").getBytes());
//				}
